            ...
            <AnimatePresence>
                {status && (
                    <motion.div
                        ...
                        exit={{ opacity: 0, y: -50 }}
                        className="fixed z-50 px-8 py-4 font-medium -translate-x-1/2 border shadow-2xl top-8 left-1/2 rounded-2xl border-cyan-500/30 bg-cyan-500/20 text-cyan-300 backdrop-blur-xl"
                    >
                        {status}
                    </motion.div>
                )}
                ...
                <div className="grid w-full max-w-6xl gap-0 overflow-hidden border shadow-2xl rounded-3xl border-white/5 md:grid-cols-2">
                    ...
                    >
                        ...
                        <div className="relative perspective-1000 h-80">
                            ...
                            >
                                <div
                                    className="font-black text-7xl text-cyan-400"
                                    style={{
                                        textShadow: `
       ...
       <p className="mt-1 text-xs text-zinc-500">Katharine Gerould</p>
                    ...
                    >
                        ...
                        <div className="flex items-center gap-3 mb-8 md:hidden">
                            <div className="w-8 h-8 rounded-lg shadow-lg bg-gradient from-cyan-400 to-teal-600 shadow-cyan-500/20" />
                        ...
                        <form onSubmit={submit} className="space-y-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                    autoFocus
                                    className={`w-full rounded-xl border bg-white/5 px-4 py-3 text-white placeholder-zinc-500 backdrop-blur-sm transition focus:border-cyan-500/50 focus:ring-2 focus:ring-cyan-500/20 focus:outline-none ${errors.email
                                        ? 'border-red-500/50'
                                        : 'border-white/10'
                                        }`}
                                    placeholder="email@example.com"
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <button
                                        ...
                                        className="absolute -translate-y-1/2 top-1/2 right-3 text-zinc-400 hover:text-emerald-400"
                                    >
                                        {showPassword ? (
                                            <EyeOff size={20} />
                                        ) : (
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                />
                                <label className="text-sm cursor-pointer text-zinc-400">
                                    Se souvenir de moi
                                </label>
                            </div>

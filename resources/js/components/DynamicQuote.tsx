        ...
        <div className="relative h-24 overflow-hidden">
            <AnimatePresence mode="wait">
                ...
                >
                    {/* Citation */}
                    <motion.p
                        className="text-lg italic font-medium leading-relaxed text-cyan-300"
                        initial={{ scale: 0.95 }}
                        animate={{ scale: 1 }}
                    ...
                    >
                        —{' '}
                        <span className="relative font-medium text-cyan-400">
                            {quotes[index].author}
                            <motion.span
                                animate={{
            ...
            <div className="absolute inset-0 pointer-events-none">
                <div className="absolute bottom-0 h-32 -translate-x-1/2 rounded-full left-1/2 w-96 bg-cyan-500/5 blur-3xl" />
            </div>
        </div>
    );
}
